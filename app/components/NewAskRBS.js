...
import askBackgroundImage from '../../app/assets/AskBackground.png';

export default  NewAskRBS = ({children, ...props}) => {
    ...
    const beginAsk = async () => {
        //Create chat room
        const newChatRoom = await DataStore.save(new ChatRoom({newMessages: 0, topic: topic}));
