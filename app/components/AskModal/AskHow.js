...
import { ScrollView, ImageBackground, TouchableOpacity, StyleSheet, Modal, Button, SafeAreaView, View, Text } from "react-native";
...
export default AskHow = ({ navigation, ...props }) => {
    
    return (
            <View style={styles.innerContainer} >
                <Text>Ask How test</Text>
                <Button title='Go to Ask Who' onPress={()=>{
                    navigation.navigate('Ask Who')}}/>
            </View>
      );
    }
